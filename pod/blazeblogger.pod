...
B<blaze-submit> [B<-c> I<file>] [B<-b> I<directory>] [B<-d> I<directory>]
[B<-H> I<address>] [B<-p> I<port>] [B<-u> I<username>] [B<-P> I<password>]
...
=item B<blaze-submit>(1)

Upload the static content to the remote server.
